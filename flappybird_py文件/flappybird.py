...
class Bird(object):
    ...
    def __init__(self):
        ...
        # 定义鸟的3种状态列表
        self.birdStatus = [pygame.image.load("assets/波.png"),
                            pygame.image.load("assets/波.png"),
                            pygame.image.load("assets/波.png")]
...
class Pipeline(object):
    ...
    def __init__(self):
        ...
        self.pineUp   = pygame.image.load("assets/龟.png")
        self.pineDown = pygame.image.load("assets/酷霸王.png")
...
if __name__ == '__main__':
    ...
    while True:
        ...
        background = pygame.image.load("assets/背景.jpg") # 加载背景图片
