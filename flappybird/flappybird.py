...
class Bird(object):
    ...
    def __init__(self):
        ...
        # 定义鸟的3种状态列表
        self.birdStatus = [pygame.image.load("波.png"),
                            pygame.image.load("波.png"),
                            pygame.image.load("波.png")]
...
class Pipeline(object):
    ...
    def __init__(self):
        ...
        self.pineUp   = pygame.image.load("龟.png")
        self.pineDown = pygame.image.load("酷霸王.png")
...
if __name__ == '__main__':
    ...
    while True:
        ...
        background = pygame.image.load("背景.jpg") # 加载背景图片
